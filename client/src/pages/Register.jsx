...
// 메서드 가져와서 사용
  ...
  return (
    <>
      <Form onSubmit={registerUser}>   // 유저등록 메서드
        <Row
          style={{
            height: "100vh",
          ...
          <Col xs={6}>
            <Stack gap={3}>
              ...
              <Form.Control type="email" placeholder="Email"  onChange={(e) =>   
                  updateRegisterInfo({ 		// 해당값이 변경될때마다 updateRegisterInfo값이 변경되게 
                    ...registerInfo,
              ...
              <Button variant="primary" type="submit">
                {isRegisterLoading ? "Creating your account" : "Register"}  // 처리중일때와 아닐때의 처리
              </Button>
{registerError?.error && <Alert variant="danger">  //에러처리나면 해당 메세지 나오게 처리
